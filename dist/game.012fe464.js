...
var pipeBottom = new Image(); // Создаем все обьекты для анимации

bird.src = 'img/flappy_bird_bird.png';
bg.src = 'img/flappy_bird_bg.png';
foreGround.src = 'img/flappy_bird_fg.png';
pipeUp.src = 'img/flappy_bird_pipeUp.png';
pipeBottom.src = 'img/flappy_bird_pipeBottom.png'; // Аудио

var fly = new Audio();
var score_audio = new Audio();
fly.src = 'audio/fly.mp3';
score_audio.src = 'audio/score.mp3'; // отступ между препятствиями

var gap = 90; // слушаем нажатие на любую клавишу
...
var score = 0; // позиция птички

var xPosition = 10;
var yPosition = 150;
var gravity = 1; // рисуем все елементы в канвасе
...
function draw() {
  ...
  for (var i = 0; i < pipe.length; i++) {
    ...
    pipe[i].x--; // добавляем новые препятствия
    ...
    if (xPosition + bird.width >= pipe[i].x && xPosition <= pipe[i].x + pipeUp.width && (yPosition <= pipe[i].y + pipeUp.height || yPosition + bird.height >= pipe[i].y + pipeUp.height + gap) || yPosition + bird.height >= canvas.height - foreGround.height) {
